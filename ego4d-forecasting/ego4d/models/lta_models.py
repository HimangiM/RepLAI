...
from .video_model_builder import SlowFast, _POOL1, MViT, R2Plus1D
from .build import MODEL_REGISTRY


@MODEL_REGISTRY.register()
class MultiTaskR2plus1D(R2Plus1D):
...
class ForecastingEncoderDecoder(nn.Module):
    ...
    def build_clip_backbone(self):
        ...
        elif cfg.MODEL.ARCH == "r2plus1d":
            self.backbone = R2Plus1D(backbone_config, with_head=True)
        # replace with:
